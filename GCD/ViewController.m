...
- (NSMutableArray *)dataSource{
    if (nil == _dataSource) {
        _dataSource = [NSMutableArray arrayWithObjects:@[
                       ...
                       @"dispatch_async + globalQueue(异步 + 全局队列)"],@[@"BlockTask1",@"BlockTask2",@"BlockTask3",@"BlockTask4",@"BlockTask5"],@[@"dispath_once",@"dispatch_after",@"dispatch_group",@"dispatch_barrier_async"],nil];
    }
    return _dataSource;
}
@end
